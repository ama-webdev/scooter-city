                ...
                <div class="card-body">
                    <form action="{{ route('admin.bikes.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            @enderror
                            <img src="{{ asset('assets/img/preview.jpg') }}" alt="" id="preview-image">
                        </div>
                        <div class="form-group">
                            <label for="">Description</label>
                            <textarea name="desc" id="description" class="form-control @error('desc') is-invalid @enderror">{{ old('desc') }}</textarea>
                            @error('desc')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
